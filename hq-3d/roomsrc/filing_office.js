...
plaque.height = 300
plaque.size = 0.0032
plaque.res = 1   // not the engine default of 2: this canvas is read from three metres
...
sign.height = 220
sign.size = 0.0035
sign.res = 1   // not the engine default of 2: this canvas is read from three metres
...
term.height = 460
term.size = 0.0028
term.res = 1   // not the engine default of 2: this canvas is read from three metres
...
memo.height = 780
memo.size = 0.0030
memo.res = 1   // not the engine default of 2: this canvas is read from three metres
...
rw.height = 380
rw.size = 0.0032
rw.res = 1   // not the engine default of 2: this canvas is read from three metres
