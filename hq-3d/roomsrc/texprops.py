...
MODELS = {
    ...
    'c_wallTop':   'modular-cave-kit/template-wall-top.glb',
    'c_wallCnr':   'modular-cave-kit/template-wall-corner.glb',
    'c_floor':     'modular-cave-kit/template-floor.glb',
    't_block':     'fantasy-town-kit/wall-block.glb',
    't_blockHalf': 'fantasy-town-kit/wall-block-half.glb',
    't_overhang':  'fantasy-town-kit/overhang.glb',
    't_stairStone':'fantasy-town-kit/stairs-wide-stone.glb',
    't_archTopD':  'fantasy-town-kit/wall-arch-top-detail.glb',
